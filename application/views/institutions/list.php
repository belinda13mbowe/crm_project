...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="row page-title-header">
                            <div class="col-12">
                                <div class="page-header">
                                    <span style="font-size:1em !important;font-weight: bold">TAASISI</span>
                                    <span style="float: right !important;margin-right: 20px;cursor: pointer" onclick="show_add_institution()">
                                        <i class="fa fa-plus-square-o text-success" title="Sajili" style="font-weight: bold !important;"></i>
                                    </span>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Add Mkazi Modal -->
        <div class="modal fade" id="modal_add_institution" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <form id="frm_institution" method="post" action="javascript:save_data()">
                    <input type="hidden" id="txt_mode">
                    <input type="hidden" id="txt_institution_id" name="txt_institution_id">
                                ...
                                <div class="card" style="padding: 0 !important;">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label class="control-label">Taasisi</label>
                                            <select class="form-control" id="txt_inst" name="txt_inst"  required>
        ...
        <div class="modal fade" id="modal_add_payment" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <form id="frm_payments" method="post" action="javascript:add_payments()">
                    <input type="hidden" id="txt_institution" name="txt_institution">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color: #05101e;color: white;padding: 8px 20px !important;">
        ...
        <script src="<?= base_url();?>public/assets/data/institutions.js"></script>
        ...
        <script>
            ...
            $(document).ready(function() {
                table = $("#data").DataTable({
                    ...
                    ordering:false,
                    processing:true,
                    ajax: {url: $("#base_url").html() + 'Institutions/data', type: 'post'},
                    columns: [
                        {data: "extension", defaultContent: ''},
                        {data: "inst", defaultContent: ''},
