...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="row page-title-header">
                            <div class="col-12">
                                <div class="page-header">
                                    <span style="font-size:1em !important;font-weight: bold">WAKAZI</span>
                                    <span style="float: right !important;margin-right: 20px;cursor: pointer" onclick="show_add_mkazi()">
                                        <i class="fa fa-plus-square-o text-success" title="Sajili Mkazi" style="font-weight: bold !important;margin-right: 10px"></i>
                                    </span>
                                    <!--span style="float: right;color:red;cursor: pointer;margin-right: 20px" onclick="print_data(1)"><i class="fa fa-file-pdf-o"></i></span-->
                                </div>
                            </div>
                        </div>
        ...
        <!-- Add Mkazi Modal -->
        <div class="modal fade" id="modal_add_mkazi" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <form id="frm_mkazi" method="post" action="javascript:save_data()">
                    <input type="hidden" id="txt_mode">
                    <input type="hidden" id="txt_mkazi_id" name="txt_mkazi_id">
                            ...
                            <div class="col-md-12 grid-margin stretch-card" style="padding: 0 !important;height: 100% !important;">
                                <div class="card" style="padding: 0 !important;">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Kanda</label>
                                            <select class="form-control" id="txt_zone" name="txt_zone"  required onchange="get_monitors(this.value)">
                                                <?php if(isset($zones)){echo $zones;} ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Shina</label>
                                            <select class="form-control" id="txt_shina" name="txt_shina"  required>
                                                <?php if(isset($mashina)){echo $mashina;} ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Mfuatiliaji</label>
                                            <select class="form-control" id="txt_monitor" name="txt_monitor"  required> </select>
                                        </div>
        ...
        <div class="modal fade" id="modal_add_payment" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <form id="frm_payments" method="post" action="javascript:add_payments()">
                    <input type="hidden" id="txt_mkazi" name="txt_mkazi">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color: #05101e;color: white;padding: 8px 20px !important;">
        ...
        <script src="<?= base_url();?>public/assets/data/wakazi.js"></script>
        <script src="<?= base_url();?>public/assets/data/reports.js"></script>
        ...
        <script>
            ...
            $(document).ready(function() {
                table = $("#data").DataTable({
                    ...
                    ordering:false,
                    processing:true,
                    ajax: {url: $("#base_url").html() + 'Wakazi/data', type: 'post'},
                    columns: [
                        {data: "extension", defaultContent: ''},
                        {data: "name", defaultContent: ''},
                        {data: "phone", defaultContent: ''},
                        {data: "zone", defaultContent: ''},
                        {data: "shina", defaultContent: ''},
