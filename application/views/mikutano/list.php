...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="row page-title-header">
                            <div class="col-12">
                                <div class="page-header">
                                    <span style="font-size:1em !important;font-weight: bold">MIKUTANO</span>
                                    <span style="float: right !important;margin-right: 20px;cursor: pointer" onclick="show_add_mkutano()">
                                        <i class="fa fa-plus-square-o text-success" title="Sajili Mkutano" style="font-weight: bold !important;"></i>
                                    </span>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Add Mkazi Modal -->
        <div class="modal fade" id="modal_add_mkutano" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <form id="frm_mkutano" method="post" action="javascript:save_data()">
                    <input type="hidden" id="txt_mode">
                    <input type="hidden" id="txt_mkutano_id" name="txt_mkutano_id">
        ...
        <div class="modal fade" id="modal_add_payment" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <form id="frm_payments" method="post" action="javascript:add_payments()">
                    <input type="hidden" id="txt_mkutano" name="txt_mkutano">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color: #05101e;color: white;padding: 8px 20px !important;">
        ...
        <script src="<?= base_url();?>public/assets/data/mikutano.js"></script>
        ...
        <script>
            ...
            $(document).ready(function() {
                table = $("#data").DataTable({
                    ...
                    ordering:false,
                    processing:true,
                    ajax: {url: $("#base_url").html() + 'Mikutano/data', type: 'post'},
                    columns: [
